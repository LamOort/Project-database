...
from django.contrib.auth.models import Course, Curriculum, Degreeprogram, Implementation, Person, PersonDegreeprogram, PersonImplementation, Room, RoomImplementation, Subgroup, SubgroupImplementation
